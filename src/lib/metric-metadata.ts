...
export const METRIC_CATALOG: Record<string, MetricDefinition> = {
  ...
  'ga4.conversions': { key: 'ga4.conversions', source: 'ga4', unit: 'count', calculationMethod: 'Summe der in GA4 konfigurierten Schlüsselereignisse (Key Events)', calculationVersion: 2, defaultCoverage: 'modeled', coverageNote: GA4_COVERAGE },
  ...
  'ga4.paidSearch': { key: 'ga4.paidSearch', source: 'ga4', unit: 'count', calculationMethod: 'GA4-Sitzungen mit Session Default Channel Group Paid Search', calculationVersion: 2, defaultCoverage: 'modeled', coverageNote: GA4_COVERAGE },
